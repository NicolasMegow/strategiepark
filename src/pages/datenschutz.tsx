...
const DatenschutzPage = () => (
  <Layout>
    ...
    <p>
      ...
      einschlägigen gesetzlichen Vorschriften, inklusive der DSGVO. Die
      nachfolgende Erklärung informiert Sie darüber, welche Art von
      personenbezogenen Daten zu welchem Zweck auf dieser Webseite erhoben
      werden und in welchem Maße diese Daten Dritten zugänglich gemacht werden.
    </p>
    ...
    <h3>Log-Dateien</h3>
    <p>
      In den Serverstatistiken werden automatisch solche Daten gespeichert, die
      der Browser an uns übermittelt, um Ihnen den Besuch der Website zu
      ermöglichen (sogenannte „logfiles“). Dies sind im Einzelnen folgende
      Daten: <br></br>- Sprache und Version der Browsersoftware verwendetes
      Betriebssystem und dessen Oberfläche<br></br>- Referrer URL (die zuvor
      besuchte Seite) <br></br>- Hostname des zugreifenden Rechners (IP-
      Adresse) <br></br>- Datum und Uhrzeit der Serveranfrage <br></br>-
      Zeitzonendifferenz zur Greenwich Mean Time (GMT) <br></br>- Inhalt der
      Anforderung (konkrete Seite)<br></br>- übertragene Datenmenge
      ...
      innerhalb von 4 Wochen gelöscht. Wir verwenden diese Daten nur für
      statistische Auswertungen zum Zweck des Betriebs, der Sicherheit und
      Optimierung unseres Angebotes.
    </p>
    <h3>Kontaktaufnahme & vertragliche Verarbeitung</h3>
    <p>
      Bei Ihrer Kontaktaufnahme mit mir per E-Mail oder über das Kontaktformular
      werden Ihre Angaben von mir gespeichert, um Ihr Anliegen zu beantworten.
    ...
    <p>
      Diese Datenschutzhinweise wurden von der Rechtsanwaltskanzlei Sieling –
